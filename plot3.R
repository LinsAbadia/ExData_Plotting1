...
#plot and annotate
plot(df_HPCs$DateTime,df_HPCs$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
lines(df_HPCs$DateTime, as.numeric(df_HPCs$Sub_metering_1), type="l", col="black")
lines(df_HPCs$DateTime, as.numeric(df_HPCs$Sub_metering_2), type="l", col="red")
lines(df_HPCs$DateTime, as.numeric(df_HPCs$Sub_metering_3), type="l", col="blue")
